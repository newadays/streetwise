...
# instance.
CLOUDSQL_USER = 'root'
CLOUDSQL_PASSWORD = 'EqtB9yEmK5B1qu9r'
CLOUDSQL_DATABASE = 'bookshelf'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'bookshelf-219117:us-east1:booksql'
...
CLOUD_STORAGE_BUCKET = 'bookshelf-219117'
...
#  * https://bookshelf-219117.appspot.com/oauth2callback.
#
# If you receive a invalid redirect URI error review you settings to ensure
# that the current URI is allowed.
GOOGLE_OAUTH2_CLIENT_ID = \
    '791748703031-i6erch5gke0p38u2648vnkni7qtcaddi.apps.googleusercontent.com'
GOOGLE_OAUTH2_CLIENT_SECRET = '092pKI2d4UKpZ5Reo25KZ-bv'
